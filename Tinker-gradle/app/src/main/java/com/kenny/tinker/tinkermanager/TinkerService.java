...
import com.kenny.tinker.network.RequestCenter;
...
public class TinkerService extends Service {
    ...
    private void downloadPatch() {
        ...
        RequestCenter.downloadFile(mBasePatchInfo.data.downloadUrl, mFilePtch,new DisposeDownloadListener() {
                    @Override
